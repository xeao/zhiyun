...
<script type="text/javascript"> 
	...
	$('#shiping_box').html('<div style="text-align:center;width:100%;"><img src="<?php echo $aik['jiazai_ad']?>" style="width:100%"></a></div><div id="timer">0</div>');
    //设置延时函数
    function adsUp(){    
        $("#shiping_box").html('<iframe id="video" src="ck/?url=<?php 
...
?>"  allowfullscreen="true" allowtransparency="true" style="width:100%;border:none"></iframe>');  
    ...
    var t = setTimeout(adsUp,0); 
					...
					<div class="footer clearfix">
						...
						<span class="text-muted" id="xuji">正在为您播放-<?php echo $data['data'][0]['vod_name'];?><span class="js"></span></span>
					</div>
				</div>
...
<?php
                ...
                foreach($d as $k=>$v){    
                    foreach ($v as $cc){
                        ...
                        $title= $u[0];
                        echo
                        '<a data-num="1" href="ck/?url='.$urls.'" class="btn-play-source">
                        '.$title.'</a>';
                        }
                    }   
                }
			...
			<div class="hy-layout clearfix"><div style="margin-top:0px"></div>
				...
				<div class="tab-content">
					<div class="hy-play-list tab-pane fade in active" id="list3">
						<div class="item">
							<div class="plot">
								<font color="#FFFFFF"><?php echo $data['data'][0]['vod_content'];?></font>
								</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="static/js/z_stat-5665993_5665993.js"></script><a href="<?php echo $aik['pcdomain'];?>">返回首页</a><?php echo $aik['tongji']?>
