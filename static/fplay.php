<?php  include 'inc/aik.config';$yl='active';
$mjk=$aik['jiekouyy'];
$srurl = 'http:'.$player;
...
<title><?php echo $xcname[0];?>-正在播放-<?php echo $aik['sitename'];?></title>
...
function SwitchAreaa(){
    ...
    //设置延时函数
    function adsUp(){    
        $("#cms_player").html('<iframe allowFullscreen="true" src="<?php echo $mjk;?>http:<?php echo $player;?>" id="video" style="width:100%;border:none" allowtransparency="true" allowfullscreen="true" frameborder="0" scrolling="no"></iframe>');  
    }
    //五秒钟后自动收起
...
<li><a class="btn btn-sm btn-default"onclick="SwitchAreaa()"> <i class="icon iconfont icon-collection"></i>视频报错</a></li>
						...
						<span class="text-muted" id="xuji">正在为您播放<?php
if (!empty($xname3[0])){?></span><?php }?>

					</div>
                        <p style="text-align:center;color: #ffff;font-size: 10px;background: #2d6296;padding:11px 8px;border-radius: 2px;"><font color="#FFFFFF"><?php echo $aik['icp'];?></font><font color="#FF0000" size='3'>请勿相信视频中提示广告</font></p>
						...
						<div class="hy-play-list play">
							<div class="item tyui" id="dianshijuid">
								<div class="panel clearfix">
									...
									<?php if($mjk!=""){ ?>	<li><a href="<?php echo $mjk; ?>" class="am-btn am-btn-default lipbtn" id="0" target="main">默认解析</a></li><?php } ?>
<li><a href="<?php echo $xclink[0];?>" class="am-btn am-btn-default lipbtn" id="0" target="main"><?php echo $xcname[0];?></a></li>
<?php
foreach ($xname as $key => $xvau) {
	$do = "https://v.youku.com/v_show/id_".$xlist[$key].".html";
?>
<li><a href="<?php echo $do;?>" class="am-btn am-btn-default lipbtn" id="0" target="main"><?php echo $xname[$key];?></a></li>	
<?php } ?>
	</ul>
	</div>
						</div>
			...
			<div class="hy-layout clearfix"><div style="margin-top:0px"></div>
				<div class="hy-switch-tabs">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#list3" data-toggle="tab">官方公告</a></li>
											</ul>
				</div>
...
<div id="jieguo"></div>
     ...
     <font color="#01090e">
       <input type="button" id="0" name="zd" value="若视频无显示请返回选择其他播放源或刷新"  />
