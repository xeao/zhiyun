...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="tablecss">
<tr class="thead">
<td colspan="10" align="center">影片推存发布<a href="https://jq.qq.com/?_wv=1027&k=5j71hMj" target="_blank">【请查看影片发布说明.TXT文档】</a></td>
</tr>
<tr style="color:#999;">
    <td valign="top" style="padding-left:20px;"><span style="color:blue">★、提示：你可以在此处自定义添加自己喜爱的影片发布至首页电影尝鲜推存板块。</br>
    </td>
</tr>
<?php
