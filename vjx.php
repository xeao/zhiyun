...
function SwitchAreaa(){
    ...
    //设置延时函数
    function adsUp(){    
        $("#cms_player").html('<iframe allowFullscreen="true" src="<?php echo $aik['jiekouyy']?><?php echo $_GET['url'];?>" id="video" style="width:100%;border:none" allowtransparency="true" allowfullscreen="true" frameborder="0" scrolling="no"></iframe>');  
    }
    //五秒钟后自动收起
...
<li><a class="btn btn-sm btn-default"onclick="SwitchAreaa()"> <i class="icon iconfont icon-collection"></i>视频报错</a></li>
						...
						<span class="text-muted" id="xuji">正在为您播放视频</span>
...
<li><a href="<?php echo $aik['jiekouyy']?><?php echo $_GET['url'];?>" class="am-btn am-btn-default lipbtn" id="0" target="main">解析线路1</a></li><li><a href="<?php echo $aik['jiekouyy1']?><?php echo $_GET['url'];?>" class="am-btn am-btn-default lipbtn" id="1" target="main">解析线路2</a></li>	<li><a href="<?php echo $aik['jiekouyy2']?><?php echo $_GET['url'];?>" class="am-btn am-btn-default lipbtn" id="2" target="main">解析线路3</a></li>
	</ul>
	</div>
						</div>
					</div>
