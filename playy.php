...
<link href="static/css/iconfont1.css" rel="stylesheet" type="text/css" />
...
<title><?php echo $timu[$gg];?>-正在播放-<?php echo $aik['sitename'];?></title>
<meta name="description" content="智云影音，<?php echo $aik['sitename']?>，联系QQ号2248186422,QQ交流群921019449"> 
<meta name="keywords" content="<?php echo $timu[$gg];?><?php echo $xarr[$gg];?>-播放页">  
<style type="text/css">
...
<script type="text/javascript"> 
    ...
    //设置延时函数
    function adsUp(){    
        $("#cms_player").html('<iframe id="video" src="ck/?url=<?php echo $qz1;?>"  style="width:100%;border:none" allowtransparency="true" allowfullscreen="true" frameborder="0" scrolling="no"></iframe>');  
    }
    //五秒钟后自动收起
    var t = setTimeout(adsUp,0); 
						...
						<li><a class="btn btn-sm btn-default" href="javascript:location.reload()"> <i class="icon iconfont icon-collection"></i> 刷新</a></li>
						</ul>
												<ul class="cleafix hidden-sm hidden-xs" style="position: absolute;right: 0;">
                        <li><a class="btn btn-sm btn-default" href="so.php?sousuo="> <i class="icon iconfont icon-collection"></i> 搜索</a></li>
						</ul>
						<span class="text-muted" id="xuji">正在播放-<?php echo $timu[$gg];?></span><span id="jishu" style="display:none;"></span>
					</div>
...
<a onclick="xldata('ck/?url=',this)" data-url="ck/?url=" class="btn btn-sm btn-default btn1"  id="xl1">云解析</a>   
</span>
</div>
</div>
<script type="text/javascript">
...
<li><a href="<?php echo $qz1;?>" class="btn1" target="ajax"  id="0"p_name="1"><?php echo $timu[$gg];?></a></li>
...
<script type="text/javascript">
	...
	function jiazainame(jiid){
		...
		var tishi="";
		if (name=="") {
			tishi=('正在播放：<?php echo $xarr[$gg];?> - '+$("#"+jiid).text()+'');
		}else{
			 tishi = ('正在播放：<?php echo $xarr[$gg];?> - '+name+'');
		}
		/*if (tishi.length>30) {
...
<div class="hy-video-details active clearfix">
					<div class="item clearfix">
						<dl class="content">
                            							<dt><img src="<?php echo $imge[$gg];?>" alt= ""style=" width: 100%;" ></dt>
							<dd class="clearfix">
							<div class="head">
								<h3><?php echo $timu[$gg];?></h3>
							</div>
							
							<ul>
                              								
								<font color="#FFFFFF"><li><span>名称 ：
<?php echo $timu[$gg];?>                                                                                            </span></li>
								<li><span class="text-muted">主播：</span><?php echo $xarr[$gg];?></li>
<?php
}
?>                             </font>  
							</ul>							
			...
			<div class="hy-layout clearfix">
				...
				<div class="hy-video-ranking side clearfix">
					<div class="head">
						...
						<h4><i class="icon iconfont icon-top text-color"></i> 舞曲风云榜</h4>
					</div>
					<div class="item">
						<ul class="clearfix">
							<?php
						...
						if ($i<20){
						$do='playy.php?post='.$xlink[$key];
						echo "<li class='text-overflow'><span class='pull-right text-color'>->></span><a href='$do' title='$xvau'>
						<em class='number active '>$xhot[$key]</em>$xvau</a></li>	";
						$i ++;}}
						?>
...
<?php echo $aik['tongji']?><a href="javascript:history.back()">返回上页</a>
