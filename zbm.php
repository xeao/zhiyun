...
<title>高清美女直播频道<?php echo $aik['sitename']?></title>
...
<a href='moviejs.php' target='_self'>极速</a>
      ...
      <dl class="cleafix">
        ...
        <dd class="clearfix">
				<div class="up-ul2">	
<a href="zbm.php">全部</a>
<a href="yy.php" target="_self">YY舞曲</a>   
<a href="music.php" target="_self">音乐</a>
<a href="mvk.php?m=1" target="_self">MV视频</a>
<a href="zhibo.php" target="_self">电视</a>
 </div>
</dd>
      </dl>
		...
		<div class="hy-layout clearfix" style="margin-top: 10px;">
			<div class="hy-switch-tabs active clearfix">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="zbm.php">美女直播</a></li>
					<li><a href="javascript:location.reload()">刷新页面</a></li>
