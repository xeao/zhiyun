...
<script>
  ...
  </script><title>在线音乐-<?php echo $aik['sitename']?></title>
...
<iframe scrolling="value" id="iframe-player" name="iframe-player" src="./music/" width="100%" height="600" scrolling="no" allowtransparency="true" allowfullscreen="true" frameborder="0"></iframe>
